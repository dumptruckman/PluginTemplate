...
package com.dumptruckman.plugintemplate.test.utils;
...
import com.dumptruckman.plugintemplate.util.FileUtils;
...
public class TestInstanceCreator {
    ...
    public boolean setUp() {
        try {
            ...
            plugin = PowerMockito.spy(new PluginTemplate());

            // Let's let all MV files go to bin/test
            doReturn(pluginDirectory).when(plugin).getDataFolder();

            // Return a fake PDF file.
            PluginDescriptionFile pdf = new PluginDescriptionFile("PluginTemplate", "dev",
                    "com.dumptruckman.plugintemplate.PluginTemplate");
            ...
            when(mockPluginManager.getPlugin("PluginTemplate")).thenReturn(plugin);
